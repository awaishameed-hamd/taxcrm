  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Faster+One&family=Rajdhani:wght@400;500;600;700&family=Outfit:wght@400;500;600;700;800&display=swap" />
      </head>
      <body>{children}</body>
    </html>
  )
