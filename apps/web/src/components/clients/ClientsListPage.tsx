                        ...
                        {(canCreate || canEdit || canDelete) && (
                          <div style={{ display: 'flex', gap: 6, justifyContent: 'flex-end' }}>
                            ...
                            <button onClick={() => handleToggleActive(r)} title={r.isActive !== false ? 'Deactivate' : 'Activate'}
                              style={{ width: 20, height: 20, borderRadius: 6, border: `1px solid ${P.border}`, background: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: r.isActive !== false ? '#EF4444' : '#22C55E' }}
                            ...
                            {canDelete && (
                              <button onClick={() => setConfirmDelete(r)} title="Delete permanently"
                                style={{ width: 20, height: 20, borderRadius: 6, border: `1px solid ${P.border}`, background: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#B91C1C' }}
                          ...
                          <>
                            {c.user?.hasPortalAccess && (
                              <button onClick={() => handleSendInvite(c)}
                                ...
                                style={{
                                  height: 20, padding: '0 8px', borderRadius: 6, fontSize: 11, fontWeight: 700,
                            ...
                            <button onClick={() => setConfirmToggle(c)} title={c.user?.isActive !== false ? 'Deactivate' : 'Activate'}
                              style={{ width: 20, height: 20, borderRadius: 6, border: `1px solid ${P.border}`, background: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: c.user?.isActive !== false ? '#EF4444' : '#22C55E' }}
