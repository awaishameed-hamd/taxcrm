      ...
      data: {
        ...
        clientProfile: {
          create: {
            ...
            hasAnnualBilling:            dto.hasAnnualBilling ?? false,
            annualBillingAmount:         dto.annualBillingAmount ?? 0,
            annualSalesTax:              dto.annualSalesTax ?? false,
            annualSalesTaxAuthorities:   dto.annualSalesTaxAuthorities ?? [],
            annualIncomeTax:             dto.annualIncomeTax ?? false,
            annualWht:                   dto.annualWht ?? false,
